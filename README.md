...
> 当前校准版本：**kimi-code v0.26.0**（tag 2026-07-16，核对 2026-07-17）。更新前先 `kimi --version` 比对；
...
| `kimi-subagent/` | `kimi-subagent` | ★ 宿主把 `kimi` 当子 agent：`kimi -p`、stream-json、传上下文、并发委派、多轮、内置 `coder` 的后台任务/Plan/Skill/嵌套 Agent、解析 |
